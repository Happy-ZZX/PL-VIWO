...
public:
  ...
  void update_feature(size_t id, double timestamp, size_t cam_id, float u, float v, float u_n, float v_n, bool chi_test, bool triangulated, Eigen::Vector3d p_FinG);

  void update_feature_stereo(size_t id, double timestamp, size_t cam_id, float u, float v, float u_n, float v_n, bool stereo_feature);
  /**
